 ...
 * @author alu20923266m
 */
public class MainSnake extends javax.swing.JFrame {

    /**
     * Creates new form MainSnake
     */
    public MainSnake() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MainSnake.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
